...
exports.GithubRegistryClient = void 0;
...
const debug = (0, debug_1.default)("live-plugin-manager.GithubRegistryClient");
class GithubRegistryClient {
    constructor(auth) {
        if (auth) {
            ...
            switch (auth.type) {
                case "token":
                    this.headers = Object.assign(Object.assign({}, (0, httpUtils_1.headersTokenAuth)(auth.token)), { "user-agent": "live-plugin-manager" });
                    break;
                case "basic":
    ...
    get(repository) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const pkgContent = yield (0, httpUtils_1.httpJsonGet)(urlPkg, Object.assign(Object.assign({}, this.headers), { accept: "application/vnd.github.v3+json" }));
    ...
    download(destinationDirectory, packageInfo) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const tgzFile = yield (0, tarballUtils_1.downloadTarball)(packageInfo.dist.tarball);
